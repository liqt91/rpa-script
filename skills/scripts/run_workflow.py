...
finishes. Prints a compact per-step summary. Used by the generate-workflow skill
for mandatory post-generation verification.

(copied from .claude/skills/command-test/scripts/run_workflow.py — keep in sync)

Usage (from repo root):
    python skills/scripts/run_workflow.py <wf_id> [--timeout 480] [--port 8000]
"""
import argparse
import datetime
import json
