...
@register_handler(type="inputElement", label="输入文本",
...
class InputElementHandler:
    params = [
        ...
        Param("scope", "匹配范围", "str-dropdown", default="local", options=[{"label": "当前外层元素内", "value": "local"}, {"label": "全页面", "value": "global"}], group="advanced"),
        Param("loopAnchor", "锚点元素", "str-var", default="", group="anchor"),
        Param("visibilityMode", "元素可见性", "str-dropdown", default="visible", options=[{"label": "仅可见", "value": "visible"}, {"label": "所有", "value": "any"}], group="advanced"),
    ]