...
@register_handler(cmd="catch", label="捕获异常", category="异常处理", runtime="control",
    is_container=True, is_branch=True,
    icon="fa-exclamation-triangle", icon_color="text-red-500", bg_color="bg-red-50", category_order=48, command_order=20)
class CatchHandler:
    params = [
