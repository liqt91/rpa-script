...
@register_handler(cmd="ifDictContains", label="如果字典包含键", category="流程控制", runtime="control",
    is_container=True, closes_with="endIf",
    icon="fa-book", icon_color="text-cyan-500", bg_color="bg-cyan-50", category_order=40, command_order=70)
