...
@register_handler(cmd="ifVarEquals", label="如果变量相等", category="流程控制", runtime="control",
    is_container=True, closes_with="endIf",
    icon="fa-equals", icon_color="text-cyan-500", bg_color="bg-cyan-50", category_order=40, command_order=40)
