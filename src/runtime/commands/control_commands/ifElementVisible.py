...
@register_handler(cmd="ifElementVisible", label="如果元素可见", category="流程控制", runtime="control",
    is_container=True, closes_with="endIf",
    icon="fa-eye", icon_color="text-cyan-500", bg_color="bg-cyan-50", category_order=40, command_order=10,
