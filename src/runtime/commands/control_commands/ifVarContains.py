...
@register_handler(cmd="ifVarContains", label="如果变量包含", category="流程控制", runtime="control",
    is_container=True, closes_with="endIf",
    icon="fa-search", icon_color="text-cyan-500", bg_color="bg-cyan-50", category_order=40, command_order=50)
