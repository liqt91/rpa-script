...
@register_handler(cmd="ifListContains", label="如果列表包含", category="流程控制", runtime="control",
    is_container=True, closes_with="endIf",
    icon="fa-list", icon_color="text-cyan-500", bg_color="bg-cyan-50", category_order=40, command_order=60)
