  ...
  return (
    <Tag className={outerClass}>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        ...
        {params.map((p, idx) => (
          <div key={idx} className="border border-[#e8e8e8] rounded p-3 space-y-2">
            ...
            <div>
              <label className="block text-[10px] text-gray-400 mb-1">变量名（用于插值）</label>
              <input
                value={p.name || ''}
            ...
            <div>
              <label className="block text-[10px] text-gray-400 mb-1">类型</label>
              <select
                value={p.type || 'text'}
            ...
            {p.type === 'select' && (
              <div>
                <label className="block text-[10px] text-gray-400 mb-1">选项（JSON 或逗号分隔）</label>
                <input
            ...
            <div>
              <label className="block text-[10px] text-gray-400 mb-1">默认值</label>
              {p.type === 'bool' ? (
                <select
