...
description: "RPA Script with FastAPI backend and workflow editor frontend"
globs: ["src/**/*.py", "ui/**/*"]
language: python
...
- Dev:        `fastapi dev src/runtime/main.py`
- Test:       `pytest`
- Lint:       `ruff check src`
- Structural: `python -m harness.check` (must pass before any PR)
